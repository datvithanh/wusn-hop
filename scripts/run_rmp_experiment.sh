# python mfea_nrk/mfea_task_sim.py --task-file data/tasks/run_uu_pvalue.txt --rmp 0.1 --n-jobs 6
...
# python mfea_nrk/mfea_task_sim.py --task-file data/tasks/run_total_uu.txt --rmp 0.3
# python mfea_nrk/mfea_task_sim.py --task-file data/tasks/run_total_uu.txt --rmp 0.4
# python mfea_nrk/mfea_task_sim.py --task-file data/tasks/run_total_uu.txt --rmp 0.5
# python mfea_nrk/mfea_task_sim.py --task-file data/tasks/run_total_uu.txt --rmp 0.6
